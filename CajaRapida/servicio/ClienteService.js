 sap.ui.define([ 
	...
	"use strict";
	return {
		consultarCliente: function(oParam, callback,context) {
			UtilHttp.httpGet(Constantes.services.consultarCliente+UtilUi.geneararFiltro(oParam) , Constantes.IdApp, function(result) {
