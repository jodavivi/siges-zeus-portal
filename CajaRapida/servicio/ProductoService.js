 sap.ui.define([ 
	...
	"use strict";
	return {
		consultarProductoDisponibilidad: function(oParam, callback,context) {
			UtilHttp.httpGet(Constantes.services.consultarProductoDisponibilidad+UtilUi.geneararFiltro(oParam) , Constantes.IdApp, function(result) {
