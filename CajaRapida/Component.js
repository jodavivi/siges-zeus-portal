sap.ui.define([
	...
	"sap/ui/Device",
	"com/telcomdataperu/app/CajaRapida/model/models",
	"com/telcomdataperu/app/CajaRapida/util/UtilUi"
], function (UIComponent, Device, models, UtilUi) {
	"use strict";

	return UIComponent.extend("com.telcomdataperu.app.CajaRapida.Component", {
		...
		init: function () {
			...
			this.setModel(models.modelCajaRapida(), "modelCajaRapida");
