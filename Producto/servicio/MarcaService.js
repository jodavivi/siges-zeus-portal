 sap.ui.define([ 
	...
	"use strict";
	return {
		consultarMarca: function(oParam, callback,context) {
			UtilHttp.httpGet(Constantes.services.consultarMarca+UtilUi.geneararFiltro(oParam) , Constantes.IdApp, function(result) {
