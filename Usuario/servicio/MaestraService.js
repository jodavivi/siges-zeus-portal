 sap.ui.define([ 
	...
	"use strict";
	return {
		consultarParametros: function(oParam, callback,context) {
			UtilHttp.httpGet(Constantes.services.consultarParametros+UtilUi.geneararFiltro(oParam) , Constantes.IdApp, function(result) {
