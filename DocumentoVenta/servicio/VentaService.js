 sap.ui.define([ 
	...
	"use strict";
	return {
		consultarDocumentoVenta: function(oParam, callback,context) {
			UtilHttp.httpGet(Constantes.services.consultarDocumentoVenta +UtilUi.geneararFiltro(oParam) , Constantes.IdApp, function(result) {
