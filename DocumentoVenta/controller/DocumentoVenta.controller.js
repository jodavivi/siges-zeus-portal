sap.ui.define([
	...
	'../util/UtilUi',
], function (Controller, BaseController, VentaService, UIComponent, UtilPopUps, Filter, FilterOperator, Sorter, models, JSONModel, Fragment, MaestraService, UtilUi) {
	"use strict";

	return BaseController.extend("com.telcomdataperu.app.DocumentoVenta.controller.DocumentoVenta", { 
		onInit: function () {     
			var self = this;  
